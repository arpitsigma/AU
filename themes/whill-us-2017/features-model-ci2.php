						...
						<?php else: ?>
							<div id="product-video-bg" style="background: url('<?php echo get_post_thumbnail_src( 'origin_size' ); ?>') center top no-repeat; background-size: cover;">
							  <div class="p-main-visual__video">
								<div class="player" data-property="{videoURL:'0WNiy9MY8hE', containment:'.p-main-visual__video', autoPlay:true, loop:true, mute:true, startAt:0, opacity:1, showControls: false, showYTLogo: false, gaTrack: false, quality: 'highres'}"></div>
							  </div>
							</div>
							<?php if($hide == false):?><iframe id="product-video" src="https://www.youtube.com/embed/0WNiy9MY8hE?enablejsapi=1&mute=1&autoplay=1&loop=1&controls=0&playlist=0WNiy9MY8hE&disablekb=1&showinfo=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><?php endif; ?>
						<?php endif; ?>
							<div class="video-overlay intro-lg">
								<div class="overlay-content">
									<h1>Move More. Live More.</h1>
									<span>Introducing the NEW</span>
									<p class="no-margin">WHILL Model C2</p>
								</div>
							</div>
							<div class="btn-movie-play-wrapper">
						    <a href="https://www.youtube.com/watch?v=0WNiy9MY8hE" class="btn-movie-play vp-s" id="btn-maas-vision" data-yt="0WNiy9MY8hE"><div class="inner"></div></a>
							</div>
					</div>
